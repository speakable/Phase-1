...
$("table#robot td").click(function(){
   ...
   {
   var mySound = new buzz.sound( "cartoon/" + robotwords[id-1], {
    formats: [ "mp3" ]
	});
	mySound.play();
   selectedrobotid = id;
...
$("table#tools td").click(function(){
   ...
   {    
             var mySound = new buzz.sound( "cartoon/" + toolwords[id-1], {
    formats: [ "mp3" ]
	});
	mySound.play();
	selectedtoolid = id;   
...
{
$("#r" + selectedrobotid).css("background","none");
$("#rb" + selectedrobotid).attr({src: "images/man/m" + selectedrobotid + ".png"});
$("#t" + selectedtoolid).css("background","none");
